...
def slideC(sprite : Sprite, x, y, seconds : float):
    return asyncio.create_task(sprite.slide(x,y,seconds))
...
"""
tps._info("Testing slideC WITHOUT await")
tps._info("Resetting..")
slideC(ada, 0, 100, 3)
tps._info('ada slideC done!')
slideC(bob, 0, -100, 3)
tps._info('bob slideC done!')
"""
"""
tps._info("Testing slideC WITH await")
tps._info("Resetting..")
tps._info('ada goes sliding...!')
await slideC(ada, 0, 100, 3)
tps._info('ada slideC done!')
tps._info('bob goes sliding...!')
await slideC(bob, 0, -100, 3)
tps._info('bob slideC done!')
"""
